...
The course starts on 19 feb 2026 and ends at the end of June. The course lasts 3 hours per week at Computer Science Laboratory, IIS headquarters via Roma 298. For details refer to [Course Details](./details.md)
...
The activity will be entirely laboratory-based in a Google Colab environment (alternatively, students can use their own laptop), with specific integration of the Gemini APIs. A final Hackathon is planned, in which groups of students will compete in a test involving the analysis of a real mathematical/physical model. [Course Details](./details.md)
